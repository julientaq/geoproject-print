...
$section_title_1 = get_post_meta(get_the_ID(), 'meta-title_1', true);
$section_title_2 = get_post_meta(get_the_ID(), 'meta-title_2', true);
$section_title_3 = get_post_meta(get_the_ID(), 'meta-title_3', true);
$section_title_4 = get_post_meta(get_the_ID(), 'meta-title_4', true);
$section_title_5 = get_post_meta(get_the_ID(), 'meta-title_5', true);
$section_title_6 = get_post_meta(get_the_ID(), 'meta-title_6', true);
$section_title_7 = get_post_meta(get_the_ID(), 'meta-title_7', true);
...
$txtFacultatif = get_post_meta(get_the_ID(), '_wp_editor_text', true);
...
// printf('$txtFacultatif' . $txtFacultatif);
