<script>
    ...
    let marker = document.querySelectorAll('.markerdata');
    ...
    mapContainers.forEach((container, index) => {
        ...
        mapContainers[container] = L.map(container.id).setView([51.505, -0.09], 13);

        console.log(mapContainers[index]);
